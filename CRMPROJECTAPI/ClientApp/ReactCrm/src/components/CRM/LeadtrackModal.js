...
const LeadtrackModal = ({ visible, onClose, lead, history, reviews }) => {
  ...
  return (
    ...
    >
      <div className="mb-4">
        <p>
          <strong>Mobile:</strong> {lead?.mobileNo || "N/A"}
        </p>
        <p>
          <strong>Vehicle Model:</strong> {lead?.modelName || "N/A"}
        </p>
        <p>
          <strong>Registration:</strong> {lead?.registrationNo || "N/A"}
        </p>
      </div>
