...
const LeadsDisplayExcelRecords = () => {
  ...
  const fetchInitialData = async () => {
    ...
    try {
      getRequest(
        `/api/Leads/get_leads_by_excelname?excelName=${excelName}`
      ).then((response) => {
  ...
  const Assignedcolumns = [
    ...
    },
    {
      ...
      filters: [
        ...new Set(assignedLeads.map((lead) => lead.currentAddress)),
      ].map((currentAddress) => ({
        text: currentAddress,
    ...
    },
    {
      ...
      sorter: (a, b) => {
        const nameA = a.registrationDate
          ? a.registrationDate.toLowerCase()
          : "";
        const nameB = b.registrationDate
          ? b.registrationDate.toLowerCase()
          : "";
        return nameA.localeCompare(nameB);
      },
      filters: [
        ...new Set(assignedLeads.map((lead) => lead.registrationDate)),
    ...
    },
    {
      ...
      filters: [
        ...new Set(assignedLeads.map((lead) => lead.registrationNo)),
      ].map((registrationNo) => ({
        text: registrationNo,
    ...
    },
    {
      ...
      filters: [
        ...new Set(assignedLeads.map((lead) => lead.currentVehicle)),
      ].map((currentVehicle) => ({
        text: currentVehicle,
    ...
    },
    {
      ...
      filters: [
        ...new Set(assignedLeads.map((lead) => lead.assignedToName)),
      ].map((assignedToName) => ({
        text: assignedToName,
  ...
  const notAssignedcolumns = [
    ...
    },
    {
      ...
      filters: [
        ...new Set(notAssignedLeads.map((lead) => lead.fatherName)),
      ].map((fatherName) => ({
        text: fatherName,
        value: fatherName,
      })),
...

    {
      ...
      filters: [
        ...new Set(notAssignedLeads.map((lead) => lead.districtName)),
      ].map((districtName) => ({
        text: districtName,
        value: districtName,
      })),
    ...
    },
    {
      ...
      filters: [
        ...new Set(notAssignedLeads.map((lead) => lead.currentAddress)),
      ].map((currentAddress) => ({
        text: currentAddress,
        value: currentAddress,
      })),
    ...
    },
    {
      ...
      filters: [
        ...new Set(notAssignedLeads.map((lead) => lead.registrationDate)),
      ].map((registrationDate) => ({
        text: registrationDate,
        value: registrationDate,
      })),
    ...
    },
    {
      ...
      filters: [
        ...new Set(notAssignedLeads.map((lead) => lead.registrationNo)),
      ].map((registrationNo) => ({
        text: registrationNo,
        value: registrationNo,
      })),
    ...
    },
    {
      ...
      filters: [
        ...new Set(notAssignedLeads.map((lead) => lead.currentVehicle)),
      ].map((currentVehicle) => ({
        text: currentVehicle,
        value: currentVehicle,
      })),
    ...
    },
    {
      ...
      filters: [
        ...new Set(notAssignedLeads.map((lead) => lead.categoryName)),
      ].map((categoryName) => ({
        text: categoryName,
        value: categoryName,
      })),
    ...
    },
    {
      ...
      filters: [
        ...new Set(notAssignedLeads.map((lead) => lead.productName)),
      ].map((productName) => ({
        text: productName,
        value: productName,
      })),
    ...
    },
    {
      ...
      filters: [
        ...new Set(notAssignedLeads.map((lead) => lead.assignedToName)),
      ].map((assignedToName) => ({
        text: assignedToName,
        value: assignedToName,
      })),
    ...
    },
    {
      ...
      filters: [
        ...new Set(notAssignedLeads.map((lead) => lead.followUpDate)),
      ].map((followUpDate) => ({
        text: followUpDate,
        value: followUpDate,
      })),
                    ...
                    <Table
                      ...
                      rowSelection={{
                        ...
                        onChange: (selectedRowKeys, selectedRows) => {
                          setSelectedLeads(
                            selectedRows.map((row) => row.leadId)
                          );
                        },
                      }}
                      pagination={{
